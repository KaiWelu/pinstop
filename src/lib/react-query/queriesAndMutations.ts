...
export const useGetPostById = (postId: string) => {
  return useQuery({
    ...
    enabled: !!postId, //enables fetching only if the id changes
  });
};
...
// revisit this. because i dont completely understand it :)
...
export const useGetSavedPostsById = (ids: string[]) => {
  return useQuery({
    queryKey: [QUERY_KEYS.GET_SAVED_POSTS_BY_ID],
